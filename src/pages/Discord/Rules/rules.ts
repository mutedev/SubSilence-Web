export default [
  ...
  'Do not upload harmful links or media (NSFL or links to things such as malware, scripts or virusses)',
  'Only speak/text in English or Dutch, failure to do so will lead to a warn/kick/ban',
